<x-app-layout>
    ...
    <div class="flex h-screen items-center justify-center text-wrap text-chocolate" id="loading">
        <div class="text items-center text-center">
            ...
            <h1 class="text-xl font-bold md:font-extrabold md:text-4xl">Loading Data Gallery..</h1>
                ...
                <div id="galleryModalContent"
                    ...
                    <div class="flex-1 overflow-y-auto flex flex-col">
                        ...
                        <div class="w-full flex justify-center items-center bg-mocca">
                            <img id="galleryModalImage" class="max-h-[60vh] w-auto object-contain mx-auto"
