...
<x-app-layout class="">
    ...
    <section id="gallery" class="container hidden mx-auto mt-20 py-24 px-6 bg-vanilla">
        ...
        <div class="flex justify-center mb-12 hidden lg:flex">
            <div id="categoryButtons" class="flex gap-4 bg-mocca px-4 py-2 rounded-full text-sm font-semibold">
                <button data-category="all"
                    class="px-4 py-2 bg-[#66391c] text-vanilla hover:bg-[#F2E5BF] rounded-full category-button">all</button>
                <button data-category="proker"
                    class="px-4 py-2 text-[#66391c] hover:bg-[#F2E5BF] rounded-full category-button">proker</button>
                <button data-category="prestasi"
                    class="px-4 py-2 text-[#66391c] hover:bg-[#F2E5BF] rounded-full category-button">prestasi</button>
                <button data-category="tweets"
                    class="px-4 py-2 text-[#66391c] hover:bg-[#F2E5BF] rounded-full category-button">tweets</button>
            </div>
        </div>
