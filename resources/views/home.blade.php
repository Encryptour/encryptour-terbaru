<x-app-layout class="bg-vanilla">
    ...
    <div class="flex h-screen items-center justify-center text-wrap text-chocolate" id="loading">
        <div class="text items-center text-center">
            ...
            <h1 class="text-xl font-bold md:font-extrabold md:text-4xl">Loading Data Home..</h1>
        ...
        bg-mocca bg-opacity-10 rounded-3xl p-6 xl:px-24 flex flex-col justify-center items-center text-chocolate overflow-hidden">
            ...
            <div class="tes">
                ...
                <section id="Gallery" class="container mx-auto mt-20 py-4 px-6 ">
                    ...
                    <p
                        class="max-w-4xl text-[#66391c] font-medium md:font-semibold md:text-base text-sm leading-relaxed mb-6">
                        ...
                        @foreach ($data as $item)
                            <a href="{{ route('gallery.index') }}">
                                ...
                                <div class="relative gallery-item w-full h-80 rounded-lg shadow-lg overflow-hidden"
                                    ...
                                    <!-- Category Top Right -->
                                    <div
                                        class="absolute top-3 right-3 backdrop-blur-md bg-chocolate/40 rounded-full px-3 py-1">
                                        ...
                                        <div class="gallery-item bg-cards/20 rounded-lg shadow-lg overflow-hidden">
                                            ...
                                            <div class="absolute inset-0 flex flex-col justify-between p-4 z-10">
                                                ...
                                                <div>
                                                    ...
                                                    <h3 class="text-xl font-bold mt-2 text-white">{{ $item['title'] }}
                                                    </h3>
                                                </div>
                                            </div>
