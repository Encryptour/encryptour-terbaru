<x-app-layout>
        <link rel="icon" type="image/x-icon" href="{{ asset('jajal/logo/logo1.png')}}" />
        <link rel="stylesheet" href="{{ asset('jajal/styles.css') }}">
        ...
        <div class="slider-container">
            <div id="slider">
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo1.png')}}" alt="Slide 1">
                    <h1 class="text-md md:text-4xl font-bold">Logo ENCRYPTOUR</h1>
                </div>
                <div class="slide ">
                    <img class="w-20 h-auto" src="{{ asset('jajal/logo/logo2.png') }}" alt="Slide 2">
                ...
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo3.png')}}" alt="Slide 3">
                ...
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo4.png')}}" alt="Slide 4">
                ...
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo5.png')}}" alt="Slide 5">
                ...
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo6.png')}}" alt="Slide 6">
                ...
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo7.png')}}" alt="Slide 7">
                ...
                <div class="slide ">
                    <img src="{{ asset('jajal/logo/logo8.png')}}" alt="Slide 8">
            ...
            <div class="slider-container-v2">
                <div id="slider-v2">
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot1.png')}}" alt="Image 1">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot1.png')}}" alt="Image 2">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot2.png')}}" alt="Image 3">
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot3.png')}}" alt="Image 4">
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot4.png')}}" alt="Image 5">
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot6.png')}}" alt="Image 6">
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot5.png')}}" alt="Image 7">
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        <img src="{{ asset('jajal/maskot/mascot1.png')}}" alt="Image 8">
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
    ...
    That’s alright
        ...
        <script src="{{ asset('jajal/script.js') }}"></script>
</x-app-layout>
