<x-app-layout>
    ...
    <div class="flex h-screen items-center justify-center text-wrap text-chocolate" id="loading">
        <div class="text items-center text-center">
            ...
            <h1 class="text-xl font-bold md:font-extrabold md:text-4xl">Loading Data Identitas..</h1>
    ...
    @if (empty($is_fake))
        <div id="view" class="hidden">
            ...
            <div class="container1">
                <div class="content rounded-r-[40px]">
                    <h3>visi</h3>
                    <p>Menjadi mahasiswa/i Teknik Komputer Universitas Diponegoro angkatan 2024 yang kompeten,
                        berintegritas,
                        serta menumbuhkan lingkungan kekeluargaan guna mendukung pengembangan keterampilan.</p>
                </div>
            </div>

            <div class="container2">
                <div class="content rounded-l-[40px]">
                    <h3>misi</h3>
                    <ol>
                        <li>Memahami teknologi komputer dengan memanfaatkan sumber daya akademik.</li>
                        <li>Menerapkan nilai integritas (jujur, tanggung jawab, peduli) dan beretika di dalam kehidupan
                            sehari-hari</li>
                        <li>Bekerja sama dalam mewujudkan hubungan yang harmonis pada internal (angkatan) dan eksternal
                            (luar
                            angkatan dan masyarakat)</li>
                    </ol>
            ...
            <div class="slider-container">
                <div id="slider">
                    ...
                    <div class="slide ">
                        ...
                        <p class="text h-full overflow-hidden overflow-y-auto md:pt-16 "><b
                                class="text-md md:text-4xl ">Kepala
                                Serigala</b> <br>
                            Kekeluargaan <br><br>

                            Dalam kawanan Serigala, serigala sangat memedulikan keluarganya. hal ini sesuai dengan misi
                            kami
                            yang ingin menumbuhkan lingkungan kekeluargaan</p>
                    </div>
                    <div class="slide ">
                        <img src="{{ asset('assets/identity/logo/logo3.png') }}" alt="Slide 3">
                        <p class="text h-full overflow-hidden overflow-y-auto md:pt-16"><b
                                class="text-md md:text-4xl ">Mulut
                                Serigala Yang Terbuka </b><br>
                            kesiapan melindungi <br><br>

                            Mulut yang terbuka memiliki arti kesiapan untuk melindungi kawanannya, hal ini sesuai dengan
                            nama
                            angkatan 24 untuk saling melindungi satu sama lain</p>
                    </div>
                    <div class="slide ">
                        <img src="{{ asset('assets/identity/logo/logo4.png') }}" alt="Slide 4">
                        <p class="text h-full overflow-hidden overflow-y-auto md:pt-16"><b
                                class="text-md md:text-4xl ">Sirkuit
                                Elektronik </b><br>
                            Kemajuan Teknologi <br><br>

                            Menandakan kemajuan teknologi serta hubungan angkatan kami dengan Department Teknik
                            Komputer.
                        </p>
                    </div>
                    <div class="slide ">
                    ...
                    <div class="slide ">
                        ...
                        <p class="text h-full overflow-hidden overflow-y-auto md:pt-16"><b
                                class="text-md md:text-4xl ">Lingkaran</b> <br>
                    ...
                    <div class="slide ">
                        ...
                        <p class="text h-full overflow-hidden overflow-y-auto md:pt-16"><b
                                class="text-md md:text-4xl ">Lingkaran Biner</b> <br>
                    ...
                    <div class="slide ">
                        ...
                        <p class="text h-full overflow-hidden overflow-y-auto md:pt-16"><b
                                class="text-md md:text-4xl ">Start
                                and Stop</b><br>

                            Diberikan sebuah tanda panah kebawah yang menandakan permulaian untuk membaca Encryptour
                            dengan
                            searah jarum jam, lalu terdapat strip sebagai pembatas yang menandakan bahwa biner sudah
                            berakhir
                        </p>
                    </div>
                </div>
            ...
            <div class="slider-container-v2">
                <div id="slider-v2">
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div
                            class="description-v2 flex items-center justify-center h-full overflow-hidden overflow-y-auto md:pt-16">
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                            <p><b class="text-md md:text-4xl "><q>LOCKIE</q></b>
                                <br>
                                Lockie memiliki arti keamanan atau aman sebagai maskot yang melambangkan angkatan kami,
                                kami
                                angkatan 24 yang ingin menumbuhkan kekeluargaan, kami memberikan rasa aman kepada
                                angkatan
                                kami
                                hal ini sesuai dengan nama dan visi kami.
                            </p>
                        </div>
                    </div>
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                            <p><b class="text-md md:text-4xl ">Ekspresi Ceria</b><br>
                                Semangat dan Ramah
                                <br><br>
                                Menunjukkan bahwa angkatan memiliki rasa semangat dalam saling menjaga dan ramah untuk
                                memberikan sebuah hubungan yang harmonis ke internal maupun eksternal
                            </p>
                        </div>
                    </div>
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                            <p><b class="text-md md:text-4xl ">Mata Terbuka Lebar</b><br>
                                ...
                                <br><br>
                                Memiliki rasa kompeten yang sangat tinggi untuk meraih tujuan sesuai dengan visi dan
                                misi
                            </p>
                        </div>
                    </div>
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                            <p><b class="text-md md:text-4xl ">Forever Salute</b><br>
                                Salam Angkatan
                                <br><br>
                                Forever salute menunjukan bahwa angkatan 24 memiliki rasa saling menjaga dan memberikan
                                rasa
                                aman
                            </p>
                        </div>
                    ...
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                            <p><b class="text-md md:text-4xl ">Work Jacket</b><br>
                                ...
                                <br><br>
                                Sebagai pakaian yang umum digunakan di lingkungan kerja, work jacket bisa mewakili
                                semangat
                                kerja sama dan gotong-royong dalam mencapai tujuan bersama sebagai angkatan.
                            </p>
                        </div>
                    </div>
                    <div class="slide-v2 gap-1 md:gap-5 ">
                        ...
                        <div class="description-v2 h-full overflow-hidden overflow-y-auto md:pt-16">
                            <p><b class="text-md md:text-4xl ">Bentuk Ekor</b><br>
                                Inisial Encryptour
                                <br><br>
                                Bentuk ekor menjuntai dengan membentuk huruf seperti “e”, melambangkan inisial
                                Encryptour.
                            </p>
                        </div>
                    </div>
